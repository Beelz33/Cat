...
def jugador_vs_com():
    ...
    turno = 0  # Variable para contar los turnos
    ...
    while turno < 9:
        ...
        if valor != 0:
            print(valor)
            continue  # Continuar al siguiente ciclo si hay un error en la jugada
        ...
        turno += 1  # Se incrementa el turno después del movimiento del jugador
        
        if turno == 9:
            print("Empate par de mancos")
            break
        ...
        while True:
            ...
            if valor_computadora == 0:
                break  # Salir del bucle si la jugada de la computadora es válida
        ...
        turno += 1  # Se incrementa el turno después del movimiento de la computadora
    
    if turno == 9 and ganador(tablero) == 0:
